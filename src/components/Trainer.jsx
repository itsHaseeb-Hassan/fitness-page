      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-wrap -mx-4">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="text-center text-white">
                  ...
                  <ul className="flex justify-center space-x-4 mt-4">
                    <li><span  className="fa fa-facebook animate-fadeInUp" style={{ animationDelay: '1s' }}></span></li>
                    <li><span  className="fa fa-twitter animate-fadeInUp" style={{ animationDelay: '1.3s' }}></span></li>
                    <li><span  className="fa fa-behance animate-fadeInUp" style={{ animationDelay: '1.9s' }}></span></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="w-full sm:w-1/2 md:w-1/3 px-4 mb-8 animate-fadeInUp" style={{ animationDelay: '2s' }}>
            <div className="relative">
              <img src={img2} className="w-full h-auto" alt="Trainer" />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="text-center text-white">
